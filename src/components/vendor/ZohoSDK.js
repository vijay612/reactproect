...
export const ZOHO = (function() {
  ...
  return {
    ...
    CRM: (function() {
      ...
      function g(a) {
        var e = { category: 'USER' };
        a.ID ? (e.ID = a.ID) : a.Type && (e.Type = a.Type);
        return d(e);
      }
      function l(a) {
        return d({
      ...
      return {
        ...
        CONFIG: {
          ...
          getCurrentUser: function() {
            return h('CURRENT_USER').then(function(a) {
              return a.users[0];
            });
          }
        },
...
function ZSDK() {
  ...
  function c(a) {
    ...
    if ('undefined' !== typeof ZSDKModelManager) {
      for (var c in b) window.ZSDKModelManager.AddModel(c, b[c]);
      m.Model = window.ZSDKModelManager.GetModelStore();
    }
    p = a.uniqueID;
    r = a.connectors;
  ...
  function e(a, b, c) {
    for (var d = ''; d !== a; ) return (d = a), (a = a.replace(b, c));
    return a;
  }
  function u(a, b) {
    b = b.replace(/\[(\w+)\]/g, '.$1');
  ...
  (function() {
    ...
    window.isDevMode = !!t.isDevMode;
    var a = {};
    a.isDevMode = window.isDevMode;
    ...
    'undefined' !== typeof ZSDKModelManager && window.ZSDKModelManager.Init(a);
